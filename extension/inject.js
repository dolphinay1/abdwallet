// ABD Wallet — MAIN world inject
// Sets window.ethereum and announces via EIP-6963

(function () {
  if (window._abdWalletInjected) return;
  window._abdWalletInjected = true;
