...
export const CHAINS: Chain[] = [
  ...
  { id: 8453,  name: 'Base',          shortName: 'BASE',   symbol: 'ETH',   rpcEnvKey: 'PRIVATE_RPC_URL_BASE',     explorerUrl: 'https://basescan.org',           coingeckoId: 'ethereum',           color: '#0052FF', isAlchemy: true,  logoUrl: 'https://icons.llamao.fi/icons/chains/rsz_base' },
  ...
  { id: 9001,  name: 'Evmos',         shortName: 'EVMOS',  symbol: 'EVMOS', rpcEnvKey: 'PRIVATE_RPC_URL_EVMOS',    explorerUrl: 'https://evm.evmos.org',          coingeckoId: 'evmos',              color: '#ED4E33', isAlchemy: false, logoUrl: 'https://icons.llamao.fi/icons/chains/rsz_evmos' },
  // ── Testnets ──────────────────────────────────────────────────────────────
  ...
  { id: 84532,    name: 'Base Sepolia',shortName: 'BSEP',   symbol: 'ETH',   rpcEnvKey: 'PRIVATE_RPC_URL_BASE_SEP',  explorerUrl: 'https://sepolia.basescan.org',   coingeckoId: 'ethereum',           color: '#5B6EF5', isAlchemy: true,  isTestnet: true, logoUrl: 'https://icons.llamao.fi/icons/chains/rsz_base' },
