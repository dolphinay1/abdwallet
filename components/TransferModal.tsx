      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <Button isIconOnly size="sm" variant="flat" radius="lg" onPress={onClose} className="text-[#888]">
              <X size={16} />
            </Button>
          </div>
            ...
            {step === 'enter-amount' && (
              <motion.div key="enter-amount" variants={variants.fadeUp} initial="hidden" animate="visible" exit="hidden" transition={springs.smooth}
                ...
                <div style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '1rem', padding: '14px 16px' }}>
                  <Input
                    ...
                    classNames={{
                      ...
                      input: 'text-[28px] font-black text-white',
                    }}
                  />
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 6 }}>
                    <span style={{ fontSize: 11, color: '#555' }}>≈ ${usdValue.toFixed(2)}</span>
                    <button onClick={() => setAmount(String(selectedBal))}
                      style={{ fontSize: 9, fontWeight: 900, color: '#52ffac', background: 'rgba(82,255,172,0.08)', border: '1px solid rgba(82,255,172,0.2)', borderRadius: 6, padding: '2px 8px', cursor: 'pointer', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                      Max
                    </button>
                  </div>
                </div>
                ...
                <Button
                  ...
                  className="h-12 font-black tracking-wide text-[13px]"
                >
